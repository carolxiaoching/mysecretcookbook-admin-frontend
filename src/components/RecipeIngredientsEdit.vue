<template>
  <VForm class="col-12 col-xxl-8" ref="form" v-slot="{ errors }" @submit="updateStep(3)">
          ...
          <li class="mb-8">
            <div class="d-flex align-items-center">
              ...
              <VField
                ...
                required
              />
              <a href="#" class="link-danger fs-4 me-4" @click.prevent="removeDraggableItem(index)">
    ...
    <div class="d-flex align-items-center">
      <button type="button" class="btn btn-outline-primary me-16" @click.prevent="updateStep(1)">
